...
- **External validation**: full pipeline run on two foreign projects — left-pad (JS/TS, via `--repo`) and the ecsly Dart ECS workspace (4 packages; 176-row canonical with 4 accepted cross-cutting concepts; evidence-enforced verify). Status snapshot: [`docs/superpowers/plans/2026-08-24-project-status.md`](docs/superpowers/plans/2026-08-24-project-status.md).
